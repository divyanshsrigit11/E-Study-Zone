                    ...
                    <div className="auth-form-box">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-2">
                                ...
                                <input type="text" className="form-control form-control-sm" placeholder="User Name" name="name" required onChange={handleChange} />
                            </div>
                            
                            <div className="mb-2">
                                <label className="form-label small fw-bold">EMAIL ADDRESS</label>
                                <input type="email" className="form-control form-control-sm" placeholder="name@example.com" name="email" required onChange={handleChange} />
                            </div>

                            <div className="row g-2 mb-2">
                                <div className="col-6">
                                    <label className="form-label small fw-bold">QUALIFICATION</label>
                                    <select className="form-select form-select-sm" name="qualification" onChange={handleChange}>
                                        {QUALIFICATIONS.map(q => <option key={q} value={q}>{q}</option>)}
                                    </select>
                                </div>
                                <div className="col-6">
                                    <label className="form-label small fw-bold">ROLE</label>
                                    <select className="form-select form-select-sm" name="role" onChange={handleChange}>
                            ...
                            <div className="mb-2">
                                ...
                                <input type="password" className="form-control form-control-sm" placeholder="Create password" name="password" required onChange={handleChange} />
                            </div>
