...
const TrainerDashboard = () => {
  ...
  // 1. Declare userId FIRST so the rest of the component can use it safely!
  ...
  // 2. Fetch settings and notifications (Polls every 10 seconds - SAFE LOOP)
  useEffect(() => {
  ...
  // 3. Fetch the User Profile picture (Runs exactly ONE time)
  useEffect(() => {
